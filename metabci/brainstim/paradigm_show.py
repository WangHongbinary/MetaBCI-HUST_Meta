...
def paradigm(
    ...
    if pdim == "ssvep":
        ...
        for trial in trials:
            ...
            # 1->front 2->back 3->left 4->right 5->360 
            # 6->30 7->60 8->90 9->120 10->150
            # 11->180  12->210  13->240  14->270  15->300  
            # 16->330  17->left_front  18->right_front  19->left_back  20->right_back
            ...
            if label == 1:
                ...
                move_rot(360*10000, 800)
                # move_pos(3000, 3000, 1000)
            elif label == 6:
                move_rot(30*10000, 800)
                # move_pos(-3000, 3000, 1000)
            elif label == 7:
                move_rot(60*10000, 800)
                # move_pos(-3000, -3000, 1000)
            elif label == 8:
                move_rot(90*10000, 800)
                # move_pos(3000, -3000, 1000)
            elif label == 9:
                move_rot(120*10000, 800)
                # move_yawoffset(-30*10000)
            elif label == 10:
                move_rot(150*10000, 800)
                # move_yawoffset(-60*10000)
            elif label == 11:
                move_rot(180*10000, 800)
                # move_yawoffset(-90*10000)
            elif label == 12:
                move_rot(210*10000, 800)
                # move_yawoffset(-120*10000)
            elif label == 13:
                move_rot(240*10000, 800)
                # move_yawoffset(-150*10000)
            elif label == 14:
                move_rot(270*10000, 800)
                # move_yawoffset(-180*10000)
            elif label == 15:
                move_rot(300*10000, 800)
                # move_yawoffset(-210*10000)
            elif label == 16:
                move_rot(330*10000, 800)
                # move_yawoffset(-240*10000)
            elif label == 17:
                move_pos(-3000, 3000, 1000)
                # move_yawoffset(-270*10000)
            elif label == 18:
                move_pos(3000, 3000, 1000)
                # move_yawoffset(-300*10000)
            elif label == 19:
                move_pos(-3000, -3000, 1000)
                # move_yawoffset(-330*10000)
            elif label == 20:
                move_pos(3000, -3000, 1000)
                # move_yawoffset(-360*10000)
            sleep(5)
